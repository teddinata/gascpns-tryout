<template>
  <MemberLayouts>
    ...
    <!-- Tryout Cards -->
    <div v-if="filteredTryouts.length && activeTab === 'myTryouts'"
    ...
    <!-- Empty Tryout -->
    <div v-if="!filteredTryouts.length && activeTab === 'myTryouts'" class="w-full flex justify-center items-center">
      <!-- image -->
    ...
    <!-- Buy Tryouts -->
    <div v-if="filteredTryouts.length && activeTab === 'buyTryouts'" 
